...
lsay_data <- read_csv(here("lab5", "data", "lca_lsay_sci.csv"), na = c("9999", "9999.00")) %>%          
  clean_names() %>%                                                                             
...
step1_fit_bch <- mplusModeler(step1_bch,
                            dataout=here("lab5", "bch", "Step1.dat"),
                            modelout=here("lab5", "bch", "bch_one.inp") ,
...
```{r}
output_bch <- readModels(here("lab5" ,"bch","bch_one.out"))
...
step3_fit_bch <- mplusModeler(step3_bch,
               dataout=here("lab5","bch","Step3.dat"), 
               modelout=here("lab5","bch", "bch_three.inp"), 
               check=TRUE, run = TRUE, hashfilename = FALSE)
```
